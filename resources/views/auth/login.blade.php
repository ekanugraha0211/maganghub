            ...
            <div class="row justify-content-center align-items-center ">
                <div class="col-lg-4 col-md-6">
                    <div class="text-center mb-4 d-flex justify-content-center align-items-center">
                        <img src="../assets/img/simopas.png" style="height: 12rem; filter: drop-shadow(0px 4px 8px rgba(0, 0, 0, 0.5));" alt="Logo">
                    </div>
                    <div class="card shadow-lg border-0 d-flex justify-content-center align-items-center">
