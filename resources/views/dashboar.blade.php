                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{ $totalKendaraan }}</p>
                ...
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">Data Dipinjam</p>
                                    <p class="card-title">{{ $totalDipinjam }}</p>
                                    <small class="text-muted">Jumlah Dipinjam aktif</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">Data Pengembalian</p>
                                    <p class="card-title">{{ $totalPengembalian }}</p>
